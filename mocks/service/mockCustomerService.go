...
// Source: github.com/Khanabeev/banking/service (interfaces: CustomerService)
...
import (
	...
	dto "github.com/Khanabeev/banking/dto"
	errors "github.com/Khanabeev/banking/errors"
...
func (m *MockCustomerService) GetAllCustomers(arg0 string) ([]dto.CustomerResponse, *errors.AppError) {
	m.ctrl.T.Helper()
